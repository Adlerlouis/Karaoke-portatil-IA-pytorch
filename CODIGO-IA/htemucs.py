...
"""
Espectrograma y modelo hibrido de Demucs.
...
Las capas de frecuencia aun pueden acceder a la informacion a traves de pasos de tiempo gracias al residuo DConv.
El modelo hibrido tiene una rama temporal paralela. En alguna capa, la rama temporal tiene el mismo paso
...
La perdida siempre esta en el dominio temporal, mediante la retropropagacion a traves de los metodos de salida anteriores y iSTFT. Esto permite definir modelos hibridos de manera clara. Sin embargo, esto rompe un poco el filtrado de Wiener, ya que hacer más iteraciones en el momento de la prueba cambiara la contribución del espectrograma, sin cambiar la de la forma de onda, lo que conducirá a un peor rendimiento. Intente usar la opción residual en la implementacion de Wiener de OpenUnmix, pero no mejoroi.
