...
1.     Define las opciones de línea de comandos que se pueden usar al ejecutar el script:
        tracks: Lista de rutas de las pistas a separar.
        --list-models: Lista los modelos disponibles y sale del programa.
        --out: Directorio donde se guardarán los resultados.
        --shifts: Número de corrimientos aleatorios para estabilizacion.
        --no-split y --segment: Opciones de división para manejar memoria.
        Formatos de salida (--flac, --mp3) y calidad (--mp3-bitrate, --mp3-preset).
        Manejo de stems específicos con --two-stems  para este caso usaremos este 

2. Carga del Modelo

    Usa el modulo Separator para cargar el modelo especificado.
    Puede cargar modelos individuales o "bags of models" (combinaciones).

3. Separación de Pistas

    Itera sobre las pistas proporcionadas y las separa utilizando el modelo.
    Permite ajustar las configuraciones para:
        Guardar las fuentes separadas en diferentes formatos (WAV, MP3, FLAC).
        Decidir cómo manejar los stems no seleccionados (suma o resta de otras fuentes).

4. Guardado de Resultados

    Guarda las fuentes separadas en carpetas organizadas por el nombre del modelo.
    Genera nombres de archivo basados en patrones personalizables.
"""
import argparse
import sys
