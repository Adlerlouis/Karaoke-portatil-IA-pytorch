...
def decoder_block(input_tensor, skip_tensor, num_filters):
    ...
    """
    # Ajustar las dimensiones del tensor decodificado para que coincidan con las del tensor del encoder (skip_tensor)
...
if __name__ == "__main__":
    ...
    def batch_generator(txt_folder, batch_size, total_files):
        for batch_start in range(0, total_files, batch_size):
            ...
            labels = np.random.randint(0, 2, spectrograms.shape[:3])  # Etiquetas binarias simuladas
    ...
    # Guardar el modelo
    model.save("unet_model_raspberry.h5")
